...
function Menu({personalDetails, setPersonalDetails}) {
    return (
        <div className="menu">
            <h2>Layout</h2>
            ...
            <Education  personalDetails={personalDetails} setPersonalDetails={setPersonalDetails}/>
        <Experience  personalDetails={personalDetails} setPersonalDetails={setPersonalDetails}/>
        </div>
    )
}
